...
<section class="service-banner">
  <div class="mx-row ">
    <p class="banner-title text-white">Mobile</p>
    <div class="text-white fs-5"> <a href="{{ url('/') }}"> Home </a> <span class="text-purple"> > </span>Mobile</div>
  </div>
</section>
...
@endif
    <p class="title w-75 text-center overline"> For the Fastest Mobile Repair, Select 
      ...
      <div class="product-list container-fluid mt-5">
        <div class="row row-cols-375 row-cols-2  row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xxl-4 g-2 g-sm-2 g-md-3 g-lg-4 g-xxl-5">
          ...
          <div class="col mx-0">
            <a data-bs-toggle="modal" data-bs-target="#exampleModal" href="#">
            <div class="product-box text-center rounded-5 bg-white p-4 mx-0">
              <img src="{{asset('uploads/oneplus.png')}}" class="img-fluid">
              <p class="product-name mb-0">Oneplus</p>
            </div>
          </a>
          </div>
          <div class="col mx-0">
          ...
          <div class="col mx-0">
            <a data-bs-toggle="modal" data-bs-target="#exampleModal" href="#">
            <div class="product-box text-center rounded-5 bg-white p-4 mx-0">
              <img src="{{asset('uploads/mi.png')}}" class="img-fluid">
              <p class="product-name mb-0">Xiaomi</p>
            </div>
          </a>
          </div>
          ...
          <div class="col mx-0">
            <a data-bs-toggle="modal" data-bs-target="#exampleModal" href="#">
            <div class="product-box text-center rounded-5 bg-white p-4 mx-0">
              <img src="{{asset('uploads/oppo.png')}}" class="img-fluid">
              <p class="product-name mb-0">Oppo</p>
            </div>
          </a>
          </div>
          ...
          <div class="col mx-0">
            <a data-bs-toggle="modal" data-bs-target="#exampleModal" href="#">
            <div class="product-box text-center rounded-5 bg-white p-4 mx-0">
              <img src="{{asset('uploads/vivo.png')}}" class="img-fluid">
              <p class="product-name mb-0">Vivo</p>
            </div>
          </a>
          </div>
          ...
          <div class="col mx-0">
            <a data-bs-toggle="modal" data-bs-target="#exampleModal" href="#">
            <div class="product-box text-center rounded-5 bg-white p-4 mx-0">
              <img src="{{asset('uploads/nokia.png')}}" class="img-fluid">
              <p class="product-name mb-0">Nokia</p>
            </div>
          </a>
          </div>
          ...
          <div class="col mx-0">
            <a data-bs-toggle="modal" data-bs-target="#exampleModal" href="#">
            <div class="product-box text-center rounded-5 bg-white p-4 mx-0">
              <img src="{{asset('uploads/google.png')}}" class="img-fluid">
              <p class="product-name mb-0">Google</p>
            </div>
          </a>
          </div>
          ...
          <div class="col mx-0">
            <a data-bs-toggle="modal" data-bs-target="#exampleModal" href="#">
            <div class="product-box text-center rounded-5 bg-white p-4 mx-0">
              <img src="{{asset('uploads/mobile.jpg')}}" class="img-fluid">
