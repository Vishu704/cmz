...
<section class="service-banner">
  <div class="mx-row ">
    <p class="banner-title text-white">{{$Category->cat_name}} Sell</p>
    <div class="text-white fs-5"> <a href="{{ url('/') }}"> Home </a> <span class="text-purple"> > </span>{{$Category->cat_name}} Sell</div>
  </div>
</section>
<style>
...
<!-- product list -->
<section class="product-list-container {{$Category->cat_name}}">
  ...
  <div class="mx-row">
    @if ($errors->any())
      ...
      @endif
    <p class="title w-75 text-center overline"> For the {{$Category->cat_name}} Sell, Select 
      your Model</p>
      ...
      <div class="product-list container-fluid mt-5">
        <div class="row row-cols-375 row-cols-2  row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xxl-4 g-2 g-sm-2 g-md-3 g-lg-4 g-xxl-5">
          ...
          <div class="col mx-0">
            ...
            <div class="product-box text-center rounded-5 bg-white p-3 p-md-4 mx-0">
              <div class="img-box">
                <img src="{{$prod->img}}" class="img-fluid">
              </div>
              <p class="product-name mb-0 text-truncate">{{$prod->name}}</p>
            </div>
          </a>
          </div> 
          @endforeach
