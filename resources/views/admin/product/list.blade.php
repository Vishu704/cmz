    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-3">
            <button type="button" onclick="window.location.href='{{ url('addproduct') }}';" class="btn btn-block btn-outline-primary btn-lg">+ Add New Product</button>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card-header">
                        <h3 class="card-title">Products List Table</h3>
                        ...
                        <tbody>
                          @foreach($products as $key => $product)
                            ...
                            <tr class="">
                              ...
                              <td><a href="{{ url('editproduct/'.$product->id) }}"><i class="fas fa-edit"></i>Edit</a> / 
                              <a class="text-danger" href="{{ url('deleteproduct/'.$product->id) }}"><i class="fas fa-trash"></i>Delete</a></td>
                            </tr>
                           @endforeach 
                        </tbody>
                        </table>
