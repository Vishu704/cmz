                          ...
                          {{ csrf_field() }}
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <input type="text" name="title" class="form-control" id="title" placeholder="Enter Slide title">
                              </div>
                            </div>
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <input type="text" name="slide_link" class="form-control" id="slide_link" placeholder="Enter Slide link">
                              </div>
                            </div>
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <select class="form-control" id="type" name="type">
                                  ...
                                  <option value="Service Slider">Service Slider</option>
                                  <option value="Home Page About-us Image">Home Page About-us Image</option>
                                </select>
                              </div>
                            </div>
