        ...
        <div class="container-fluid">
                    ...
                    <!-- general form elements -->
                        <div class="card card-primary">
                          ...
                          <!-- /.card-header -->
                          <!-- form start -->
                          <form action="{{ url('update-testimonial/'.$testimonial_detail->id) }}" method="post">
                          {{ csrf_field() }}
                            <div class="card-body">
                            <div class="row">
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <input type="text" name="customer_name" value="{{ $testimonial_detail->customer_name }}" class="form-control" id="" placeholder="Enter page title">
                              </div>
                            </div>
                            
                            <div class="col-md-6  doc_link">
                                <div class="form-group">
                                    <label for="doc_link">Customer Image</label>
                                    <div class="row">
                                        ...
                                        <img src="{{ $testimonial_detail->image }}" id="view_doc" class="col-md-3 {{ $testimonial_detail->image != '' ? '' : 'd-none' }} view_doc">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <textarea class="form-control rounded-0" name="testimonial" id="" rows="3" placeholder="Enter page description">{{ $testimonial_detail->testimonial }}</textarea>
                              </div>
                            </div>
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <select class="form-control" id="status" name="status">
                                  ...
                                  <option value="active" {{ ($testimonial_detail->status=='active') ? 'selected' : ''  }} >Active</option>
                                  <option value="suspended" {{ ($testimonial_detail->status=='suspended') ? 'selected' : ''  }} >Suspended</option>
                                </select>
                              </div>
                            </div>
                            </div>
