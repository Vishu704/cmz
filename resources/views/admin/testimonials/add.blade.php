                          ...
                          {{ csrf_field() }}
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <input type="text" name="customer_name" class="form-control" id="" placeholder="Enter customer name">
                              </div>
                            </div>
                            ...
                            <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <textarea class="form-control rounded-0" name="testimonial" id="" rows="3" placeholder="Enter testimonial"></textarea>
                              </div>
                            </div>
