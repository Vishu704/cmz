                        ...
                        {{ csrf_field() }}
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" name="blog_title" class="form-control" id="" placeholder="Enter page title">
                            </div>
                          </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" name="blog_slug" class="form-control" id="" placeholder="Enter page slug">
                            </div>
                          </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" name="meta_keyword" class="form-control" id="" placeholder="Enter page slug">
                            </div>
                          </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" name="meta_title" class="form-control" id="" placeholder="Enter page slug">
                            </div>
                          </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" name="meta_description" class="form-control" id="" placeholder="Enter page slug">
                            </div>
                          </div>
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              {{-- <textarea class="form-control rounded-0" name="blog_description" id="" rows="3" placeholder="Enter page description"></textarea> --}}
                              <textarea id="summernote" name="blog_description" placeholder="Enter blog description"></textarea>
                            </div>
                          </div>
