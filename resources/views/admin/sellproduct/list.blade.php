...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-9">
            <h1>Sell Products List</h1>
          </div>
          <div class="col-sm-3">
            <button type="button" onclick="window.location.href='{{ url('sell-addproduct') }}';" class="btn btn-block btn-outline-primary btn-lg">+ Add New Sell Product</button>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card-header">
                        <h3 class="card-title">Sell Products List Table</h3>
                        ...
                        <tbody>
                          @foreach($products as $key => $product)
                            ...
                            <tr class="">
                              ...
                              <td>
                                @if($product->sellcategory!='')    
                                  {{ $product->sellcategory->cat_name }}
                                @endif
                              </td>
                              <td>
                              @if($product->img!='')  
                              ...
                              <td><a href="{{ url('sell-editproduct/'.$product->id) }}"><i class="fas fa-edit"></i>Edit</a> / 
                              <a class="text-danger" href="{{ url('sell-deleteproduct/'.$product->id) }}"><i class="fas fa-trash"></i>Delete</a></td>
                            </tr>
                           @endforeach 
                        </tbody>
                        </table>
