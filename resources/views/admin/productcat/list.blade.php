    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-3">
            <button type="button" onclick="window.location.href='{{ url('addproductcat') }}';" class="btn btn-block btn-outline-primary btn-lg">+ Add New Category</button>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
                        ...
                        <tbody>
                          @foreach($productcats as $key => $productcat)
                            ...
                            <tr class="">
                              ...
                              <td><a href="{{ url('editproductcat/'.$productcat->id) }}"><i class="fas fa-edit"></i>Edit</a> / 
                              <a class="text-danger" href="{{ url('deleteproductcat/'.$productcat->id) }}"><i class="fas fa-trash"></i>Delete</a></td>
                            </tr>
                           @endforeach 
                        </tbody>
                        </table>
