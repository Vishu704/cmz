...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Add Product Issue</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Add Product Issue</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                    ...
                    <!-- general form elements -->
                        <div class="card card-primary">
                          <div class="card-header">
                            <h3 class="card-title">Add Product Issue</h3>
                          </div>
                          @if ($errors->any())
                          ...
                          <!-- /.card-header -->
                          <!-- form start -->
                          <form action="{{ url('saveproduct-issue') }}" method="post">
                          {{ csrf_field() }}
                            <div class="card-body">
                            <div class="row">
                            <div class="col-md-6">
                              <div class="form-group">
                                <label for="name">Product Issue Name</label>
                                <input type="text" name="isuue_name" class="form-control" id="name" placeholder="Enter product issue name">
                              </div>
                            </div>
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <input type="text" name="issue_slug" class="form-control" id="slug" placeholder="Enter product issue slug">
                              </div>
                            </div>
