...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Edit Product Issue</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Edit Product Issue</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                    ...
                    <!-- general form elements -->
                        <div class="card card-primary">
                          <div class="card-header">
                            <h3 class="card-title">Edit Product Issue</h3>
                          </div>
                          @if ($errors->any())
                          ...
                          <!-- /.card-header -->
                          <!-- form start -->
                          <form action="{{ url('updateproduct-issue/'.$product_detail->id) }}" method="post">
                          {{ csrf_field() }}
                            <div class="card-body">
                            <div class="row">
                            <div class="col-md-6">
                              <div class="form-group">
                                <label for="isuue_name">Product Issue Name</label>
                                <input type="text" name="isuue_name" value="{{ $product_detail->isuue_name }}" class="form-control" id="isuue_name" placeholder="Enter Product Issue name">
                              </div>
                            </div>
                            
                            <div class="col-md-6">
                              <div class="form-group">
                                <label for="slug">Product Issue Slug</label>
                                <input type="text" name="issue_slug" value="{{ $product_detail->issue_slug }}" class="form-control" id="slug" placeholder="Enter Product slug">
                              </div>
                            </div>
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <select class="form-control" id="cat_id" name="product_cat">
                                  <option value="">--Select Product category--</option>
                                  @foreach($product_cats as $key => $val)
                                  <option value="{{ $val->id }}" {{ ($product_detail->product_cat == $val->id) ? 'selected' : ''  }}>{{ $val->cat_name }}</option>
                                  @endforeach
                                </select>
                              </div>
                            </div>
                            ...
                            <div class="col-md-6  doc_link">
                                <div class="form-group">
                                    <label for="doc_link">Product Issue Image</label>
                                    <div class="row">
                                        ...
                                        <img src="{{ $product_detail->image }}" id="view_doc" class="col-md-3 {{ $product_detail->image != '' ? '' : 'd-none' }} view_doc">
                                    </div>
                                </div>
                            </div>
