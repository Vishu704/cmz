...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Edit Sell Category</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Edit Sell Category</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                    ...
                    <!-- general form elements -->
                        <div class="card card-primary">
                          <div class="card-header">
                            <h3 class="card-title">Edit Sell Category</h3>
                          </div>
                          @if ($errors->any())
                          ...
                          <!-- /.card-header -->
                          <!-- form start -->
                          <form action="{{ url('sell-updateproductcat/'.$cat_detail->id) }}" method="post">
                          {{ csrf_field() }}
                            <div class="card-body">
                            <div class="row">
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <input type="text" name="cat_name" value="{{ $cat_detail->cat_name }}" class="form-control" id="cat_name" placeholder="Enter category name">
                              </div>
                            </div>
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <input type="text" name="cat_slug" value="{{ $cat_detail->cat_slug }}" class="form-control" id="cat_slug" placeholder="Enter category slug">
                              </div>
                            </div>

                            <div class="col-md-6  doc_link">
                                <div class="form-group">
                                    <label for="doc_link">Category Image</label>
                                    <div class="row">
                                        ...
                                        <input type="hidden" name="cat_img" value="" class="doc_link" id="doc_link">
                                        <input id="photo" class="file form-control col-md-6" type="file" name="pimg" value="" onchange="getfile()">
                                        <img src="{{ $cat_detail->cat_img }}" id="view_doc" class="col-md-3 {{ $cat_detail->cat_img != '' ? '' : 'd-none' }} view_doc">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <select class="form-control" id="status" name="status">
                                  ...
                                  <option value="active" {{ ($cat_detail->status=='active') ? 'selected' : ''  }} >Active</option>
                                  <option value="suspended" {{ ($cat_detail->status=='suspended') ? 'selected' : ''  }} >Suspended</option>
                                </select>
                              </div>
                            </div>
                            </div>
