...
$('#assign_all').change(function() {
  if(this.checked) {
      $('.assign_f_m').prop("checked", 'checked'); 
  } else {
    $('.assign_f_m').prop("checked", ''); 
  }
...
$('.assign_followup_b').change(function() {
    var selected = new Array();
    $("input[class=assign_f_m]:checked").each(function () {
